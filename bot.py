...
# -------------------------------------------------------------------
CITY_PHOTOS = {
    # Картинки из папки "города" (по порядку, пока не переименованы)
    "lat=48.708&lon=44.513": ["images/1.png", "images/2.png"],   # Волгоград
    "lat=48.818&lon=44.757": ["images/3.png", "images/4.png"],   # Волжский
    "lat=50.083&lon=45.4":   ["images/5.png", "images/6.png"],   # Камышин
    "lat=50.067&lon=43.233": ["images/7.png"],                   # Михайловка
    "lat=50.8&lon=42.0":     ["images/8.png"],                   # Урюпинск
    "lat=49.773&lon=43.655": ["images/9.png"],                   # Фролово
    "lat=48.691&lon=43.526": ["images/10.png"],                  # Калач-на-Дону
    "lat=50.315&lon=44.807": ["images/11.png"],                  # Котово
    "lat=48.805&lon=44.476": ["images/12.png"],                  # Городище
    "lat=48.608&lon=42.85":  ["images/13.png"],                  # Суровикино
    
    # Новые города
    "lat=50.028&lon=45.46":  ["images/14.png"],                  # Николаевск
    "lat=50.981&lon=44.767": ["images/15.png"],                  # Жирновск
    "lat=50.045&lon=46.883": ["images/16.png"],                  # Палласовка
    "lat=48.705&lon=45.202": ["images/17.png"],                  # Ленинск
    "lat=49.058&lon=44.829": ["images/18.png"],                  # Дубовка
    "lat=50.137&lon=45.211": ["images/19.png"],                  # Петров Вал
    "lat=48.712&lon=44.572": ["images/20.png"],                  # Краснослободск (если будет фото)

    # Дефолтное фото для остальных (если не нашлось)
    "default": [
        "images/1.png", "images/3.png", "images/5.png"
    ]
}
