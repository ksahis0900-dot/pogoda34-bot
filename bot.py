...
CITY_PHOTOS = {
    ...
    "lat=48.708&lon=44.513": ["images/1Волгоград.jpg"],       # Волгоград
    "lat=48.818&lon=44.757": ["images/2Волжский.jpg"],        # Волжский
    "lat=50.083&lon=45.4":   ["images/3Камышин.jpg"],         # Камышин
    "lat=50.067&lon=43.233": ["images/4Михайловка.jpg"],      # Михайловка
    "lat=50.8&lon=42.0":     ["images/5Урюпинск.jpg"],        # Урюпинск
    "lat=49.773&lon=43.655": ["images/6Фролово.jpg"],         # Фролово
    "lat=48.691&lon=43.526": ["images/7Калач на дону.jpg"],   # Калач-на-Дону
    "lat=47.583&lon=43.133": ["images/8Котельниково.jpg"],    # Котельниково (добавим в меню ниже)
    "lat=50.315&lon=44.807": ["images/9Котово.jpg"],          # Котово
    "lat=48.608&lon=42.85":  ["images/10Суровикино.jpg"],     # Суровикино
    "lat=48.712&lon=44.572": ["images/11Краснолободск.jpg"],  # Краснослободск (имя файла с опечаткой как в источнике)
    "lat=50.981&lon=44.767": ["images/12Жирновск.jpg"],       # Жирновск
    "lat=50.533&lon=42.667": ["images/13Новоанинский.jpg"],   # Новоаннинский (добавим в меню)
    "lat=50.045&lon=46.883": ["images/14Палласовка.jpg"],     # Палласовка
    "lat=49.058&lon=44.829": ["images/15Дубовка.jpg"],        # Дубовка
    "lat=50.028&lon=45.46":  ["images/16Николаевск.jpg"],     # Николаевск
    "lat=48.705&lon=45.202": ["images/17Ленинск.jpg"],        # Ленинск
    "lat=50.137&lon=45.211": ["images/18Петров Вал.jpg"],     # Петров Вал
    "lat=49.583&lon=42.733": ["images/19Серафимович.jpg"],    # Серафимович (добавим в меню)
    
    # Городище (фото нет? используем Волгоград или дефолт)
    "lat=48.805&lon=44.476": ["images/1Волгоград.jpg"],       # Городище (рядом с Волгоградом)

    # Дефолтное фото
    "default": [
        "images/1Волгоград.jpg", "images/3Камышин.jpg"
    ]
}
